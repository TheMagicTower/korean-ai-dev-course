...
이 폴더는 학생용 강의 본문 바깥의 운영 기준, 조사 부록, 복사 가능한 서식과 실제 에이전트 실행 기록을 정리합니다. [현재 세션 핸드오프](handoff/2026-09-23.md)에는 저장소 상태와 새 세션의 재개 순서를 기록했습니다. 과정을 처음 시작한다면 [온라인 교재](https://themagictower.github.io/korean-ai-dev-course/)와 [저장소 시작 안내](../README.md)를 먼저 보세요.
