...
## 운영 서비스 비교 실험
[Signal Magazine 고도화·신규 구현 비교](production-comparison.md)에서 같은 서비스 계약으로 실제 구현한 두 경로의 프롬프트와 시간, 서버 검증을 확인하세요.
