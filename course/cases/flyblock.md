...
**현재 상태:** 설계·실습 가이드입니다. 이 저장소에 작동하는 게임이나 모델 통합은 아직 없습니다. 아래 규칙·임계값·실험 횟수는 교육용 설계안이며 측정 결과가 아닙니다.
...
- **출력 디코더:** 정해진 시간 구간의 발화량을 합법 수 점수에 연결합니다. 학습 여부·가중치·선택 규칙을 기록합니다. 어떤 신경집단을 쓸지는 근거와 작은 실험으로 결정하며 아직 확정하지 않았습니다.
