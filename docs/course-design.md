...
[사례 선택 안내](../course/cases/index.md)를 통해 데이터 서비스·실험형 게임·콘텐츠 운영을 비교합니다. 공통 프로세스는 유지하고 각자 하나를 선택해 4주를 진행합니다. 세 프로젝트의 범위를 제한한 실행 데모와 실제 에이전트 기록을 제공하며, 강사는 수업 전에 모델/데이터 환경과 학생 수행 시간을 검증해야 합니다. 준비 없이 초급 수강생의8시간 완성을 보장하지 않습니다.
