...
**현재 상태:** [실행 게임](https://themagictower.github.io/korean-ai-dev-course/projects/flyblock/)과 [실제 제작 기록](../build-lab.md)을 제공합니다. FlyWire v783의 실제12뉴런·13연결로 추출한 부분 회로이며 전뇌 모델이 아닙니다. 최초 제작은 라운드 방식이며, 최신 데모에는 [키보드·실시간 업데이트](../updates/flyblock-keyboard.md)를 적용합니다. 아래 축소 규칙은 최초 실험 설계입니다. 최신 버전의 120초 제한·입력 시점 재생·공격 전달 규칙은 업데이트 계약을 따릅니다. 기존 40경기 결과는 이전 라운드 버전의 측정입니다.
