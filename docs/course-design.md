...
[사례 선택 안내](../course/cases/index.md)를 통해 데이터 서비스·실험형 게임·콘텐츠 운영을 비교합니다. 공통 프로세스는 유지하고 각자 하나를 선택해 4주를 진행합니다. FlyBlock Arena와 Signal Magazine은 현재 설계 사례이며, 강사는 수업 전에 모델 실행/어댑터 또는 수집 샘플/모델 연결을 준비하고 시간을 검증해야 합니다. 준비 없이 초급 수강생의8시간 완성을 보장하지 않습니다.
