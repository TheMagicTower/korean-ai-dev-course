...
**현재 상태:** 설계·실습 가이드입니다. 이 저장소에 작동하는 수집기·생성 모델 연결·발행 시스템은 아직 없습니다. 아래 기사 장면은 가상이며 실제 뉴스로 게시하지 않습니다.
...
**평가:** 근거 없는 주장 수, 중복 발행 수, 보류를 놓친 사례, 한 호당 실제 비용, 수동 수정 시간, 독자 피드백을 기록합니다. 검증 자료가10건이면10건의 결과로만 보고하며 전체 뉴스의 정확도로 일반화하지 않습니다. 이 교재에는 아직 측정값이 없습니다.
