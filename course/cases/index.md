...
| [FlyBlock Arena](flyblock.md) | 사람이 블록을 놓으면 초파리 연결지도 기반 컨트롤러가 상대편 수를 고릅니다 | 외부 연구 코드 연결·시뮬레이션·기준선 비교 | 사람 대 컨트롤러 대전과 재현 가능한 실험 기록 | 설계 사례. 게임과 신경회로 어댑터 미구현 |
| [Signal Magazine](signal-magazine.md) | 아침에 AI가 만든 뉴스 초안을 확인하고 독자에게 한 호를 전달합니다 | 수집·중복 제거·근거 확인·발행·정정 | 한 주제의 작은 뉴스 매거진과 편집 흐름 | 설계 사례. 수집기·편집 화면·발행기 미구현 |

두 새 사례는 **실제로 만들 프로젝트의 설계와 실행 프롬프트**입니다. 현재 작동하는 데모나 이미 검증한 8시간 완성 사례로 표시하지 않습니다. 수강생이 세 프로젝트를 전부 만들 필요는 없습니다.
