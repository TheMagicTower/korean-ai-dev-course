...
def main():
 ...
 meta={'generated_at':datetime.now(timezone.utc).isoformat(),'parallel_start_to_last_handoff_seconds':total,'sum_worker_elapsed_seconds':aggregate,'projects':summaries,'root_start_to_local_verified_seconds':local_seconds}
...
주 에이전트의 첫 시각 관찰부터 수정·재검토를 포함한 로컬 통합 검증까지는 **{local_label}**입니다. 공개 배포 대기는 이 수치에 포함되지 않으며 제작실의 통합 기록에서 별도 확인합니다.
